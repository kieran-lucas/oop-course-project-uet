...
/**
 * Test suite verifying the contract of {@link AuctionClosedException} — thrown when a bid
 * is placed on an auction that has already ended or been closed by the scheduler.
 *
 ...
 *       {@code AuctionClosedException → AuctionException → RuntimeException}.</li>
...
class AuctionClosedExceptionTest {
   ...
   *
   * <p>Cause chaining is critical for debugging — without it, the original scheduler error
   * would be silently swallowed when {@code AuctionClosedException} is caught upstream.
   */
  @Test
  ...
  /**
   * Verifies that {@link AuctionClosedException} is a subtype of {@link AuctionException},
  ...
  /**
   * Verifies that {@link AuctionClosedException} extends {@link RuntimeException}, meaning
