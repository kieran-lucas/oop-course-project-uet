...
class AutoBidConfigDaoTest {
    ...
    void init() {
        ...
        // ID dự kiến: Seller=1, Bidder1=2, Bidder2=3
    ...
    void testFindActiveByAuctionId() {
        AutoBidConfig config1 = new AutoBidConfig(testAuction.getId(), testBidder1.getId(), new BigDecimal("1M"), new BigDecimal("50K"));
        autoBidDao.insert(config1);
        
        AutoBidConfig config2 = new AutoBidConfig(testAuction.getId(), testBidder2.getId(), new BigDecimal("2M"), new BigDecimal("100K"));
    ...
    void testUpdate() {
        AutoBidConfig config = new AutoBidConfig(testAuction.getId(), testBidder1.getId(), new BigDecimal("1M"), new BigDecimal("50K"));
        AutoBidConfig saved = autoBidDao.insert(config);
    ...
    void testDeactivateAllByAuctionId() {
        autoBidDao.insert(new AutoBidConfig(testAuction.getId(), testBidder1.getId(), new BigDecimal("1M"), new BigDecimal("50K")));
        autoBidDao.insert(new AutoBidConfig(testAuction.getId(), testBidder2.getId(), new BigDecimal("2M"), new BigDecimal("100K")));
