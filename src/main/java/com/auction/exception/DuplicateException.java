 ...
 *
 * <ul>
 *   <li>Registering a user with an existing email or username</li>
 *   <li>Creating an item with a duplicate SKU</li>
 *   <li>Inserting an entity whose primary key already exists</li>
 * </ul>
 *
 * <p>Typical usage:
 * <pre>{@code
