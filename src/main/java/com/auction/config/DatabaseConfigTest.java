...
public class DatabaseConfig {
  ...
  // [FIX #3] Thống nhất DEFAULT_USER = "postgres" khớp với file .env mẫu.
   ...
   * xử lý được ~10 SQL queries đồng thời. Với bài tập lớn (vài chục user), con số này dư thừa.
   *
  ...
  private static DataSource createDataSource() {
    ...
    // [FIX #1] Dùng LOGGER thay vì System.out.println
    // → Không lộ credentials ra console, tuân thủ logging framework
    LOGGER.debug("Kết nối database: url={}, user={}", url, user);
    ...
    // Đặt search_path khi mở connection → đảm bảo query chạy trên schema public
