 ...
 *
 * <p><b>Mục đích:</b> Là màn hình đầu tiên khi ứng dụng khởi động. Cho phép người dùng chọn vai trò
 * (ADMIN, BIDDER, SELLER) để điều hướng đến màn hình đăng nhập.
 *
 * <p><b>Các phương thức chính:</b>
 *
 * <ul>
 *   <li>{@link #goToLoginAsAdmin()} — Chuyển sang login.fxml với hint role ADMIN.
 *   <li>{@link #goToLoginAsBidder()} — Chuyển sang login.fxml với hint role BIDDER.
 *   <li>{@link #goToLoginAsSeller()} — Chuyển sang login.fxml với hint role SELLER.
 * </ul>
 *
 * <p><b>Vị trí trong kiến trúc:</b> WelcomeController là điểm khởi đầu của luồng điều hướng client.
