        ...
        actionCol.setCellFactory(
            col ->
                new TableCell<>() {
                    ...
                    private final javafx.scene.layout.HBox actionBox = new javafx.scene.layout.HBox(8, btnEnter, btnCancel);

                    {
                        ...
                        btnCancel.setOnAction(
                            e -> {
                                AuctionResponse auction = getTableView().getItems().get(getIndex());
                                try {
                                    HttpResponse<String> response = RestClient.delete("/api/auctions/" + auction.getId());
                            ...
                            if (auction != null) {
                                ...
                                if (isSeller) {
                                    ...
                                    if (isOpen) {
                                        ...
                                        btnCancel.setStyle("-fx-background-color: #e0e0e0; -fx-text-fill: #9e9e9e; -fx-cursor: default;");
                                    }
                                } else {
