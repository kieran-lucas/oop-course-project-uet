...
public class AuctionWebSocketHandler implements BidService.AuctionWebSocketBroadcaster {
    ...
    public void onConnect(WsConnectContext ctx) {
        try {
            ...
            connections.computeIfAbsent(auctionId, k -> new CopyOnWriteArraySet<>())
                .add(ctx);

            LOGGER.info("WebSocket connected: user={}, auction={}",
                username, auctionId);
    ...
    public void onClose(WsCloseContext ctx) {
        ...
        LOGGER.debug("WebSocket disconnected: statusCode={}, reason={}",
    ...
    public void broadcast(Long auctionId, BidUpdateMessage message) {
        ...
        try {
            ...
            LOGGER.debug("Broadcast to {} clients for auction {}: {}",
                auctionConnections.size(), auctionId, message.getType());
