 ...
 * <p>5 endpoints:
 * <ul>
 *   <li>GET /api/auctions — list tất cả (hỗ trợ ?status=RUNNING)</li>
 *   <li>GET /api/auctions/:id — chi tiết, trả AuctionResponse</li>
 *   <li>POST /api/auctions — seller tạo phiên (check role, check item ownership)</li>
 *   <li>PUT /api/auctions/:id — seller sửa (chỉ khi OPEN)</li>
 *   <li>DELETE /api/auctions/:id — seller/admin xóa</li>
 * </ul>
 */
