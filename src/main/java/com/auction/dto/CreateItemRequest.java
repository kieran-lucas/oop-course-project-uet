 ...
 *       categoryDetail ở đây là brand (ví dụ: "Apple")
 *   <li>"ART" → new Art(name, description, sellerId, categoryDetail) — categoryDetail ở đây là
 *       artist (ví dụ: "Van Gogh")
 *   <li>"VEHICLE" → new Vehicle(name, description, sellerId, categoryDetail) — categoryDetail ở đây
 *       là year dạng String (ví dụ: "2022"), sẽ được parse thành int
 * </ul>
 *
 * <p>Tại sao dùng 1 field categoryDetail thay vì 3 field riêng (brand, artist, year)? Vì mỗi lần
 * chỉ cần đúng 1 giá trị — nếu category = "ELECTRONICS" thì chỉ cần brand, artist và year vô nghĩa.
 * Cách này giữ JSON request gọn gàng và tránh gửi null fields.
 *
 * <p>Ví dụ JSON:
 *
 * <pre>
