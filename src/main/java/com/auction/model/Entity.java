 ...
 *
 * <p>Mọi đối tượng được lưu trong cơ sở dữ liệu đều có hai thuộc tính chung: định danh
 * duy nhất ({@code id}) và thời điểm tạo bản ghi ({@code createdAt}). Thay vì lặp lại hai
 * trường này ở các lớp như {@code User}, {@code Item}, {@code Auction}, hay
 * {@code BidTransaction}, ta khai báo chúng tại đây và để các lớp con kế thừa.
 *
 * <p>Đây là một ví dụ điển hình của ABSTRACTION trong OOP: lớp {@code Entity} mô tả tính
 * chất chung "mọi entity đều có id và createdAt" mà không gắn với một loại cụ thể nào.
 */
public abstract class Entity {
     ...
     *
     * <p>{@code createdAt} được gán bằng thời điểm hiện tại; {@code id} sẽ được DAO gán
