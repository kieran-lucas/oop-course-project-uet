 ...
 *
 * <p>Seller được phép: tạo, chỉnh sửa, xóa sản phẩm của bản thân; tạo phiên đấu giá; xem
 * kết quả của các phiên đấu giá liên quan đến mình.
 *
 * <p>Seller KHÔNG được phép: tham gia đấu giá sản phẩm do chính mình đăng — quy tắc này
 * tránh xung đột lợi ích và ngăn chặn hành vi tự đẩy giá.
 */
