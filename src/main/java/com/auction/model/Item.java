 ...
 *
 * <p>Ba loại sản phẩm: Electronics, Art, Vehicle. Phần chung (tên, mô tả, ai bán) nằm ở đây. Phần
 * riêng (brand cho electronics, artist cho art, year cho vehicle) ở subclass.
 *
...
public abstract class Item extends Entity {
   ...
   *
   * <p>POLYMORPHISM: mỗi subclass override → ItemFactory dùng giá trị này để quyết định tạo class
   * nào. Database cột category lưu giá trị này.
   */
