 ...
 *
 * <p>Lớp này mở rộng {@link Item} bằng cách bổ sung thông tin về nghệ sĩ — một thuộc tính
 * đặc thù chỉ có ý nghĩa đối với các sản phẩm thuộc danh mục nghệ thuật (ví dụ: bức
 * "Starry Night" của Van Gogh). Các danh mục khác như Electronics sẽ không sử dụng
 * trường này.
 */
