 ...
 *
 * <p>Đây là trạng thái <em>cuối cùng tích cực</em> của vòng đời phiên đấu giá: người
 * thắng cuộc đã thanh toán cho seller, hệ thống coi như giao dịch khép kín. Để bảo toàn
 * tính toàn vẹn của lịch sử giao dịch, mọi hành động làm thay đổi trạng thái phiên đều
 * bị từ chối.
 *
 * <p><b>Phân biệt với {@link CanceledState}:</b> cả hai đều là trạng thái cuối, nhưng
 * PAID phản ánh một phiên kết thúc thành công, trong khi CANCELED phản ánh một phiên bị
 * chấm dứt bất thường.
 *
 * <h2>Hành động được phép / bị từ chối</h2>
 *
 * <p>Mọi hành động đều bị từ chối với cùng một thông điệp thống nhất, làm rõ rằng phiên
 * đã được thanh toán và đóng băng vĩnh viễn.
 */
