 ...
 *
 * <p>Đây là trạng thái <em>trung gian</em> nằm giữa {@link RunningState} và {@link PaidState}. Tại
 * thời điểm chuyển sang FINISHED, phiên đã xác định được người thắng cuộc thông qua trường {@code
 * leadingBidderId} của {@link Auction}, nhưng giao dịch tài chính giữa người thắng và người bán vẫn
 * chưa hoàn tất.
 *
 ...
 * </table>
 *
 * <p><b>Chuyển trạng thái:</b> FINISHED → PAID khi seller xác nhận đã nhận được khoản thanh toán từ
 * người thắng cuộc.
 */
public class FinishedState implements AuctionState {
   ...
   * {@inheritDoc}
   *
   * <p>Cho phép chuyển trạng thái sang {@code PAID} sau khi quá trình thanh toán đã hoàn tất.
   * Method này chỉ đóng vai trò validate; việc cập nhật trạng thái thực sự do {@code
   * AuctionService} đảm nhiệm.
   */
  @Override
