 ...
 *     Auction auction = findByIdForUpdate(handle, auctionId);
 *     
 ...
 *   <li><b>BidService.java</b> — gọi findByIdForUpdate() và update() trong transaction</li>
...
public class AuctionDao {
    ...
    public Optional<Auction> findById(Long id) {
        String sql = """
            SELECT id, item_id, starting_price, current_price, leading_bidder_id,
                   start_time, end_time, status, created_at, updated_at
            FROM auctions
            WHERE id = :id
            """;
     ...
     *     // xử lý bid...
     *     auctionDao.update(handle, auction);
     *     return auction;
     * });
     * </pre>
     * 
    ...
    /**
     * Cập nhật phiên đấu giá (phiên bản dùng Handle, gọi trong transaction).
     * 
     ...
     */
    public void update(org.jdbi.v3.core.Handle handle, Auction auction) {
        String sql = """
            UPDATE auctions
    ...
    /**
     * Cập nhật phiên đấu giá (phiên bản dùng riêng, không trong transaction).
     * 
