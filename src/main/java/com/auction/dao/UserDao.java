...
public class UserDao {
    ...
    private static class UserMapper implements RowMapper<User> {
        ...
        public User map(ResultSet rs, StatementContext ctx) throws SQLException {
            ...
            switch (role) {
                case "BIDDER":
                    return new Bidder(id, username, passwordHash, email, createdAt);
                case "SELLER":
                    return new Seller(id, username, passwordHash, email, createdAt);
                case "ADMIN":
                    return new Admin(id, username, passwordHash, email, createdAt);
                default:
                    LOGGER.warn("Unknown role: {}, returning null", role);
                    return null;
            }
        }
    }
